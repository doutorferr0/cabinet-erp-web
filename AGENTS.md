...
Assento: **kimi tem ACESSO TOTAL** (decisão do user, 2026-07-28). `claude` e `kimi` NUNCA simultâneos NESTE repo (paralelo com o vitra-erp-py é permitido — repos distintos).
