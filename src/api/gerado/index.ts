...
export type lookupPostalCodeResponse200 = {
  data: PartnerAddress
  status: 200
}

export type lookupPostalCodeResponse400 = {
  data: ProblemDetails
  status: 400
}

export type lookupPostalCodeResponse401 = {
  data: NaoAutenticadoResponse
  status: 401
}

export type lookupPostalCodeResponse403 = {
  data: SemPermissaoResponse
  status: 403
}

export type lookupPostalCodeResponse404 = {
  data: ProblemDetails
  status: 404
}

export type lookupPostalCodeResponseSuccess = (lookupPostalCodeResponse200) & {
  headers: Headers;
};
export type lookupPostalCodeResponseError = (lookupPostalCodeResponse400 | lookupPostalCodeResponse401 | lookupPostalCodeResponse403 | lookupPostalCodeResponse404) & {
  headers: Headers;
};

export type lookupPostalCodeResponse = (lookupPostalCodeResponseSuccess | lookupPostalCodeResponseError)

export const getLookupPostalCodeUrl = (postalCode: string,) => {




  return `/api/postal-codes/${postalCode}`
}

/**
 * Proposto. Consulta o endereço público de um CEP e devolve o mesmo formato que os cadastros guardam. Número e complemento não pertencem ao CEP e voltam nulos; o operador os informa. O front não consulta serviço externo diretamente: este caminho deixa cache, disponibilidade e política de fornecedor sob controle do servidor.
 */
export const lookupPostalCode = async (postalCode: string, options?: Parameters<typeof apiFetch>[1]): Promise<lookupPostalCodeResponse> => {

  return apiFetch<lookupPostalCodeResponse>(getLookupPostalCodeUrl(postalCode),
  {
    ...options,
    method: 'GET'
