...
function CarouselTrack({
  ...
  return (
    <ul
      ...
      // biome-ignore lint/a11y/noNoninteractiveTabindex: duas regras de a11y em conflito, e aqui vale a outra — a `scrollable-region-focusable` do axe EXIGE foco em região que rola. Este `<ul>` rola de verdade (`overflow-x-auto`).
      tabIndex={0}
      className={cn(
