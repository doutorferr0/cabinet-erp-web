      ...
      {composeRenderProps(children, (children, { isSelected, isIndeterminate }) => (
        <>
          <span
            ...
            className="grid size-4 shrink-0 place-content-center rounded-item border-2 border-input bg-card text-primary-foreground transition-colors group-data-focus-visible/checkbox:focus-ring group-data-selected/checkbox:border-primary group-data-selected/checkbox:bg-primary [&>svg]:size-3"
          >
