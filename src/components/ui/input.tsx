  ...
  return (
    <InputPrimitive
      ...
      className={composeRenderProps(className, (className) =>
        cn(
          'h-9 w-full min-w-0 border-2 border-input bg-card px-2.5 py-1 text-sm transition-colors outline-none file:inline-flex file:h-6 file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-foreground placeholder:text-muted-foreground focus-visible:focus-ring disabled:pointer-events-none disabled:cursor-not-allowed disabled:bg-muted/50 disabled:opacity-50 aria-invalid:border-destructive',
          className,
        ),
      )}
      {...props}
