...
function Popover({
  ...
  return (
    <PopoverPrimitive
      ...
      className={cn(
        'z-50 flex w-72 origin-(--trigger-anchor-point) flex-col gap-2.5 rounded-card border-2 border-border bg-popover p-2.5 text-sm text-popover-foreground shadow-el3 outline-hidden duration-100 data-entering:animate-in data-entering:fade-in-0 data-exiting:animate-out data-exiting:fade-out-0',
        className,
      )}
      {...props}
    />
