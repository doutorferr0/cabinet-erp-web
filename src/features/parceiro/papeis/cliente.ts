...
export const papelCliente: PapelDeCadastro<Cliente> = {
  ...
  camposDeEdicao:
    'Nome, CPF/CNPJ, E-mail, Telefones, Endereço, Endereço de cobrança, Endereço comercial (com Empresa, Cargo, CNPJ e Fundação), Inscrição Estadual, IE Produtor Rural, Categoria, Profissional que indicou, Observação, Redes sociais e Ativo',
  vazio: clienteVazio,
  dtoParaForm,
